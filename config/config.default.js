...
module.exports = appInfo => {
  ...
  return {
    ...
    uploadDirConfig: [
      ...
      "/materialRepo/audio",
      "/materialRepo/video",
      "/cloudDrive/materialRepo",
      "/cloudDrive/materialRepo/_recycle",
      "/cloudDrive/materialRepo/attachment",
      "/cloudDrive/materialRepo/image",
      "/cloudDrive/materialRepo/audio",
      "/cloudDrive/materialRepo/video",
    ],
